              ...
              {#each questions as question, index}
                <div style="border: 1px solid #e5e7eb; border-radius: 8px; padding: 1.5rem; position: relative;">
                  ...
                  <div style="margin-bottom: 1rem;">
                    <label style="display: block; font-size: 0.9rem; margin-bottom: 0.25rem;">Question Text</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label style="display: block; font-size: 0.9rem; margin-bottom: 0.25rem;">Time Limit</label>
                    <select
